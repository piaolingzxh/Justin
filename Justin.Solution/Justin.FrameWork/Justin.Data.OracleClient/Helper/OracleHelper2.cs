        ...
        public static DataSet ExecutePageing(string connectionString, string queryDataString, int pageSize, int currentPageIndex, ref int totalRows, ref int totalPages)
        {
            using (OracleConnection connection = new OracleConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    paras[0] = new OracleParameter("sqlStr", OracleDbType.Varchar2);
                    paras[1] = new OracleParameter("pageSize", OracleDbType.Int32);
                    paras[2] = new OracleParameter("currentPageIndex", OracleDbType.Int32);
                    paras[3] = new OracleParameter("totalRows", OracleDbType.Int32);
                    paras[4] = new OracleParameter("totalPages", OracleDbType.Int32);
