...
public class NewsListXmlParser extends DefaultHandler {
	...
	final String ENTRY_UPDATED_TAG = "updated";// 发表时间标记
	...
	final String ENTRY_SOURCENAME_TAG = "sourceName";// 网址属性标签
	...
	public void endElement(String uri, String localName, String qName)
		...
		if (isStartParse) {// 发现目标
			...
			}else if (localName.equalsIgnoreCase(ENTRY_UPDATED_TAG)) {// 发布时间
