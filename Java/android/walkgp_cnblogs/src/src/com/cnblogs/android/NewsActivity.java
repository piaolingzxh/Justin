...
public class NewsActivity extends BaseMainActivity {
	...
	private void RedirectDetailActivity(View v) {
		...
		try {
			...
			if (news != null) {
				...
				Toast.makeText(this, "找不到该news", 3000);
				Log.d("blogId", String.valueOf(newsId));
			}
	...
	public class UpdateListViewReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context content, Intent intent) {
			/*
			 * Bundle bundle=intent.getExtras(); int[]
			 * newsIdArr=bundle.getIntArray("newsIdArray"); for(int
			 * i=0,len=listView.getChildCount();i<len;i++){ View
			 * view=listView.getChildAt(i); TextView
			 * tvId=(TextView)view.findViewById(R.id.news_text_id); int
			 * newsId=Integer.parseInt(tvId.getText().toString());
			 * 
			 * ImageView
			 * icoDown=(ImageView)view.findViewById(R.id.icon_downloaded);
			 * TextView
			 * tvTitle=(TextView)view.findViewById(R.id.news_text_title);
			 * 
